(function ($) {
    ...
    //header
    $('.header-right').append('<div class="col-xs-12 nav-btns"><a target="_blank" rel="external" href="http://sport.leeds.gov.uk/memberships" class="btn btn-lg pull-right btn-secondary nav-btn"><span class="sr-only">External link opens in new window </span>Join Today</a><a target="_blank" rel="external" href="https://www.fastdd.co.uk/platinum/start.php?c=Active-Leeds" class="btn btn-lg pull-right btn-main nav-btn"><span class="sr-only">External link opens in new window </span>Book Online</a></div>');
